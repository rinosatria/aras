...
public class HapusPengguna extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Pengguna pengguna = (Pengguna) sessionedit.getAttribute("pengguna");
        Long id = pengguna.getId();
        
        penggunax.deletePengguna(id);
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet HapusPengguna</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet HapusPengguna at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
             */
        } finally {            
