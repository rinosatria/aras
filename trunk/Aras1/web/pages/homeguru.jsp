...
<!-- DARI SINI JANGAN LUPA YG LINE 6 JUGA DIGANTI --> 
      ...
      <tr>
        <td width="164"><p>Pengguna</p></td>
        <td width="472"><p>Khusus Administrator</p></td>
    </tr>
    <tr>
        <td width="164"><p>Siswa</p></td>
        <td width="472">Berisi Daftar Siswa</td>
    </tr> 
    <tr>
        <td width="164"><p><a href="HalDaftarKelas">Kelas</a></p></td>
        <td>Berisi Daftar Kelas</td>
    </tr>
    <tr>
        <td width="164"><p><a href="HalDaftarSemester">Semester</a></p></td>
        <td>Berisi Daftar Semester</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>Khusus Administrator dan Petugas TU</td>
    </tr>
